  ...
  "components": [
    {
      ...
      "parameters": [
        ...
        },
        {
                ...
                "genericTypeInstances": [
                  {
                    ...
                    "parameterRangeGenericType": "npmd:@comunica/actor-query-result-serialize-sparql-json/^4.0.0/components/ActionObserverHttp.jsonld#ActionObserverHttp__generic_I"
                  },
                  {
                  ...
                  {
                    "@type": "ParameterRangeGenericTypeReference",
                    "parameterRangeGenericType": "npmd:@comunica/actor-query-result-serialize-sparql-json/^4.0.0/components/ActionObserverHttp.jsonld#ActionObserverHttp__generic_O"
                  },
                  {
                    "@type": "ParameterRangeGenericTypeReference",
                    "parameterRangeGenericType": "npmd:@comunica/actor-query-result-serialize-sparql-json/^4.0.0/components/ActionObserverHttp.jsonld#ActionObserverHttp__generic_TS"
                  }
                ]
              },
              {
          ...
          "default": {
            "@id": "npmd:@comunica/bus-http/^4.0.0/components/ActorHttp.jsonld#ActorHttp_default_bus"
          },
