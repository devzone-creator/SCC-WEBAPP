 ...
 */
export declare abstract class ActorRdfMetadata<TS = undefined> extends Actor<IActionRdfMetadata, IActorTest, IActorRdfMetadataOutput, TS> {
    /**
     * @param args -
     ...
     */
    constructor(args: IActorRdfMetadataArgs<TS>);
}
...
export type IActorRdfMetadataArgs<TS = undefined> = IActorArgs<IActionRdfMetadata, IActorTest, IActorRdfMetadataOutput, TS>;
